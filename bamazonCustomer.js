...
//     // If the inquirerResponse item is in-stock, inform customer of successfull transaction, otherwise inform of insufficient quantity!
//     if (inquirerResponse.purchasQTY <= stock_quantity) {
//         console.log("\nYour order has been processed for item number " + inquirerResponse.purchaseID);
//         console.log("\nYour total is " + products.price + "!\n");
//     }
//     else {
//         console.log("\nSorry, Insufficient quantity! Please try again!\n");
//     }
// });
...
// //             console.log("Deleting purchased Items...\n");
// //             connection.query(
